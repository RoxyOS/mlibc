...
#define ROXY_SYS_TIMER_CREATE (ROXY_SYS_BASE + 71)
#define ROXY_SYS_TIMER_SETTIME (ROXY_SYS_BASE + 72)
#define ROXY_SYS_TIMER_GETTIME (ROXY_SYS_BASE + 73)
#define ROXY_SYS_TIMER_GETOVERRUN (ROXY_SYS_BASE + 74)
#define ROXY_SYS_TIMER_DELETE (ROXY_SYS_BASE + 75)
#define ROXY_SYS_THREAD_CREATE (ROXY_SYS_BASE + 76)
#define ROXY_SYS_THREAD_EXIT (ROXY_SYS_BASE + 77)
#define ROXY_SYS_GET_TID (ROXY_SYS_BASE + 78)
#define ROXY_SYS_SIGTIMEDWAIT (ROXY_SYS_BASE + 79)
#define ROXY_SYS_TGKILL (ROXY_SYS_BASE + 80)
#define ROXY_SYS_CLOCK_GETRES (ROXY_SYS_BASE + 81)
#define ROXY_SYS_OPENPTY (ROXY_SYS_BASE + 82)
#define ROXY_SYS_GET_DESCRIPTOR_FLAGS (ROXY_SYS_BASE + 83)
#define ROXY_SYS_SET_DESCRIPTOR_FLAGS (ROXY_SYS_BASE + 84)
#define ROXY_SYS_GET_STATUS_FLAGS (ROXY_SYS_BASE + 85)
#define ROXY_SYS_SET_STATUS_FLAGS (ROXY_SYS_BASE + 86)
