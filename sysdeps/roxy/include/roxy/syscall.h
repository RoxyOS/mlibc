...
#define ROXY_OPEN_ACCESS_READ_ONLY 0
#define ROXY_OPEN_ACCESS_WRITE_ONLY (ROXY_OPEN_ACCESS_READ_ONLY + 1)
#define ROXY_OPEN_ACCESS_READ_WRITE (ROXY_OPEN_ACCESS_READ_ONLY + 2)

#define ROXY_OPEN_FLAGS_BASE (1ULL << 0)
